export const ABOUT = {
  title: "About",
  paragraphs: [
    "I graduated from University of Toronto in 2017",
    "In the near future i would like to travel and meet new people around the world.",
  ],
  expertise: ["JavaScript (ES6+)", "HTML & (S)CSS", "React", "Node.js"],
  quote: {
...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: ["Team sharing economy web application."],
    features: [
...
export const RESEARCH = [
  {
    title:
      "Department of Computer Science Research Volunteer - Group N-Way Merging (september 2015 – september 2016)",
    tasks: [
...
export const PUBLICATION = [
  {
    ...
    url:
      "https://www.researchgate.net/publication/303362869_Serious_games_for_NP-hard_problems_challenges_and_insights",
    collaborators: ["Christina Chung", "Angel Liu", "Asako Matsuoka", "Yutie Yang"],
    workshop: [
      {
        title:
          "GAS '16 Proceedings of the 5th International Workshop on Games and Software Engineering Pages 29-32)",
        year: "May 2016",
      },
    ],
  },
